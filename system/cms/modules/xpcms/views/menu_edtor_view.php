        ...
        // load edit via ajax
                    ...
                    $('#nav-create button:submit').live(
                            ...
                            function(e) {
                                e.preventDefault();
                                $.post(
                                        SITE_URL + 'xpcms/pages_edtor/create',
                    ...
                    $('#nav-edit button:submit').live(
                            ...
                            function(e) {
                                e.preventDefault();
                                $.post(
                                        SITE_URL + 'xpcms/pages_edtor/edit/' + $('input[name="link_id"]').val(),
                                        $('#nav-edit').serialize(),
                                        function(message) {
                                            // if message is simply "success" then it's a go. Refresh!
                                            if (message == 'success') {
                    ...
                    $('#link-list li a').livequery(
                            ...
                            function() {
                                ...
                                $('div#link-details.group-' + id + '')
                                        .load(
                                        SITE_URL + 'xpcms/pages_edtor/ajax_link_details/' + link_id,
                                        '',
                                        function() {
                                            $('div#link-details.group-' + id + '').fadeIn();
                                        });
