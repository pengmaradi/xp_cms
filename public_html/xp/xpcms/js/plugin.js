...
(function($) {
    ...
    $.fn.prettyPhoto = function(pp_settings) {
        pp_settings = jQuery.extend({animation_speed: 'fast', slideshow: 5000, autoplay_slideshow: false, opacity: 0.80, show_title: true, allow_resize: true, default_width: 500, default_height: 344, counter_separator_label: '/', theme: 'pp_default', horizontal_padding: 20, hideflash: false, wmode: 'opaque', autoplay: true, modal: false, overlay_gallery: true, keyboard_shortcuts: true, changepicturecallback: function() {
            }, callback: function() {
 ...
 */
$.extend($.ui.tabs.prototype, {paging: function(z) {
        function r() {
            p();
            l = 0;
            c = 0;
            ...
            if (l > s) {
                ...
                for (var g = 0, a = 0, n = 0, h = 0; h < j.length; h++) {
                    if (0 == a || selectedTabWidths[h] - j[h] > n)
                        n = selectedTabWidths[h] - j[h];
                    if (null == f[g])
                        f[g] = {start: h};
                    else if (0 < h && 0 == h % e.tabsPerPage || j[h] + a + k + 12 > s)
                        a + n > m && (m = a + n), g++, f[g] = {start: h}, a = 0;
                    f[g].end = h + 1;
                    a += j[h];
                ...
                0 < buttonPadding && $(".ui-tabs-paging-next",
                        b.element).css({paddingRight: buttonPadding + "px"});
                q = !0
            } else
                p();
        ...
        function v(d) {
            c += "prev" == d ? -1 : 1;
            if ("prev" == d && 0 > c && e.cycle || "next" == d && c >= f.length && !e.cycle)
                c = f.length - 1;
            else if ("prev" == d && 0 > c || "next" == d && c >= f.length && e.cycle)
                c = 0;
            var g = f[c].start, a = f[c].end;
        ...
        function w() {
            u && clearTimeout(u);
            if (x != $(window).height() || y != $(window).width())
                u = setTimeout(A, 100)
        }
        function A() {
            x = $(window).height();
        ...
        var e = {tabsPerPage: 0, nextButton: "&#187;", prevButton: "&#171;", follow: !1, cycle: !1, selectOnAdd: !1, followOnSelect: !1}, e = $.extend(e, z), b = this, q = !1, c, k, s, l, j, m, f, u = null, x = $(window).height(), y = $(window).width(), B = b.add;
        ...
        $.extend($.ui.tabs.prototype, {pagingDestroy: function() {
                p()
            }});
        r()
    }});
